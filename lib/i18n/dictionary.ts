export const dictionaries = {
  es: {
    ...
    contact: {
      eyebrow: "Contacto",
      title: "Escríbenos",
      body: "Cuéntanos de tu empresa o de lo que quieres construir. Respondemos en menos de un día hábil.",
      copy: "Copiar",
      copied: "Copiado",
  ...
  en: {
    ...
    contact: {
      eyebrow: "Contact",
      title: "Write to us",
      body: "Tell us about your company or what you want to build. We reply within one business day.",
      copy: "Copy",
      copied: "Copied",
